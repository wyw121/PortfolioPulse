...
export const Footer = () => {
  ...
  return (
    <AnimatedContainer
      direction="up"
      duration={800}
      className="border-t border-gray-200 dark:border-gray-800 bg-white/90 dark:bg-gray-900/90 backdrop-blur-sm"
    >
      <footer>
        <div className="vercel-container py-8">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-6">
            ...
            {/* 右侧 - 社交媒体图标 */}
            <AnimatedContainer direction="right" duration={600} delay={400}>
